...
async function sendReferralWelcomeEmail(email, code, lang) {
  ...
  const T = {
    ro: {
      ...
      p3: `Uite regula, om la om: recomanzi MlmPsychology cu linkul tău. Când <b>3 oameni</b> se abonează la planul tău sau mai mare și rămân activi, tu nu mai plătești nimic — luna aceea și fiecare lună cât ei rămân alături.`,
      p4: `Nu e un concurs, nu e o reducere de o săptămână. E <b>permanent</b>.`,
      hl: `3 activi = abonamentul tău e 0€`,
      p5: `În funcție de planul tău, sunt între <b>108€ și 348€ pe an</b> pe care nu-i mai scoți din buzunar — pentru 3 oameni pe care oricum i-ai fi ajutat.`,
    ...
    en: {
      ...
      p3: `Here’s the rule, person to person: you recommend MlmPsychology with your link. When <b>3 people</b> subscribe to your plan or higher and stay active, you pay nothing — that month, and every month they stick around.`,
      p4: `It’s not a contest, not a one-week discount. It’s <b>permanent</b>.`,
      hl: `3 active = your membership costs €0`,
      p5: `Depending on your plan, that’s between <b>€108 and €348 a year</b> you keep in your pocket — for 3 people you’d have helped anyway.`,
    ...
    it: {
      ...
      p3: `Ecco la regola, da persona a persona: consigli MlmPsychology con il tuo link. Quando <b>3 persone</b> si abbonano al tuo piano o superiore e restano attive, tu non paghi nulla — quel mese e ogni mese in cui restano.`,
      p4: `Non è un concorso, non è uno sconto di una settimana. È <b>permanente</b>.`,
      hl: `3 attivi = il tuo abbonamento è 0€`,
      p5: `A seconda del tuo piano, sono tra <b>108€ e 348€ all’anno</b> che ti restano in tasca — per 3 persone che avresti aiutato comunque.`,
    ...
    es: {
      ...
      p3: `Esta es la regla, de persona a persona: recomiendas MlmPsychology con tu enlace. Cuando <b>3 personas</b> se suscriben a tu plan o superior y siguen activas, tú no pagas nada — ese mes y cada mes que sigan contigo.`,
      p4: `No es un concurso ni un descuento de una semana. Es <b>permanente</b>.`,
      hl: `3 activos = tu membresía cuesta 0€`,
      p5: `Según tu plan, son entre <b>108€ y 348€ al año</b> que te quedas en el bolsillo — por 3 personas a las que ibas a ayudar de todas formas.`,
    ...
    fr: {
      ...
      p3: `Voici la règle, d’humain à humain : tu recommandes MlmPsychology avec ton lien. Quand <b>3 personnes</b> s’abonnent à ton plan ou supérieur et restent actives, tu ne paies plus rien — ce mois-là et chaque mois où elles restent.`,
      p4: `Ce n’est pas un concours, ni une promo d’une semaine. C’est <b>permanent</b>.`,
      hl: `3 actifs = ton abonnement à 0€`,
      p5: `Selon ton plan, ça fait entre <b>108€ et 348€ par an</b> que tu gardes dans ta poche — pour 3 personnes que tu aurais aidées de toute façon.`,
    ...
    de: {
      ...
      p3: `Hier die Regel, von Mensch zu Mensch: Du empfiehlst MlmPsychology mit deinem Link. Wenn <b>3 Personen</b> deinen Plan oder höher abonnieren und aktiv bleiben, zahlst du nichts mehr — in diesem Monat und in jedem Monat, in dem sie dabei bleiben.`,
      p4: `Kein Gewinnspiel, kein Rabatt für eine Woche. Es ist <b>dauerhaft</b>.`,
      hl: `3 Aktive = deine Mitgliedschaft kostet 0€`,
      p5: `Je nach Plan sind das zwischen <b>108€ und 348€ pro Jahr</b>, die in deiner Tasche bleiben — für 3 Menschen, denen du sowieso geholfen hättest.`,
...
// ============================================
const MODULE_MIN_TIER = { conectare: 'builder', fulger: 'builder', prezentare: 'builder', inchidere: 'leader', psihologie: 'builder' };
