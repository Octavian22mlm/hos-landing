...
8. NO-ORIENTED QUESTIONS: 15-20 cuvinte. Verbe: "Te-ar deranja daca...",
   ...
   ⚠️ VARIATIE GLOBALA (anti-tic): oriunde apare intrebarea-NU cu "idee gresita",
   ALTERNEAZA cu "idee absurda" ("crezi ca ar fi o idee absurda sa...?"). Ambele au impact.
   NU folosi acelasi cuvant de fiecare data — "idee gresita" repetat in 4-5 locuri pe acelasi
   apel se aude. Roteste intre "gresita" / "absurda".
